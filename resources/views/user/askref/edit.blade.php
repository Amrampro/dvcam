        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-bordered" action="{{ url('askref/edit/'.$refuge->id.'/update') }}" method="post">
                        @csrf

                        <div class="form-group">
                            <label class="col-md-3 control-label" for="inputDefault">Avez-vous plus de 21 ans ?</label>
                            <div class="col-md-3">
                                <input type="text" class="form-control" value="{{ $refuge->adult }}" disabled>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" value="{{ $refuge->sleeping_at }}" disabled>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" value="{{ $refuge->gender }}" disabled>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" value="{{ $refuge->employment }}" disabled>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" value="{{ $refuge->income }}" disabled>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" value="{{ $refuge->trained }}" disabled>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" value="{{ $refuge->training }}" disabled>
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="training" value="{{ $refuge->training }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="inputDefault">Pour combiens de temps avez-vous besoin d'être hebergé ?</label>
                            <div class="col-md-3">
                                <input type="text" class="form-control" value="{{ $refuge->training_time }}" disabled>
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="training_time" value="{{ $refuge->training_time }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" value="{{ $refuge->apport }}" disabled>
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="apport" value="{{ $refuge->apport }}">
                            </div>
                        </div>
                        <div class="col-md-6">
